...
public class ItemHardenedHoe extends HoeItem {

    public ItemHardenedHoe(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
