...
public class ItemHardenedUpgradeTemplate extends Item {
    public ItemHardenedUpgradeTemplate(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.competitivenetherite.hardenedupgradetemplate_0").withStyle(ChatFormatting.DARK_GRAY));
        ...
        pTooltipComponents.add(Component.translatable("tooltip.competitivenetherite.hardenedupgradetemplate_1").withStyle(ChatFormatting.DARK_GRAY));
    }
}
