...
public class ItemSoulstealerShovel extends ShovelItem {

    public ItemSoulstealerShovel(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
