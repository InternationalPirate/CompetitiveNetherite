...
public class ItemSoulstealerSword extends SwordItem {

    public ItemSoulstealerSword(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
