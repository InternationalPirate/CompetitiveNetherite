...
public class ItemStrangePickaxe extends PickaxeItem {

    public ItemStrangePickaxe(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
