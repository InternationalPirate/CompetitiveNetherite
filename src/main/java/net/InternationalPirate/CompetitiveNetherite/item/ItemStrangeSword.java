...
public class ItemStrangeSword extends SwordItem {

    public ItemStrangeSword(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
