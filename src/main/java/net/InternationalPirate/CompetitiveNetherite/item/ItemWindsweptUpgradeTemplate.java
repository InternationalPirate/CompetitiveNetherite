...
public class ItemWindsweptUpgradeTemplate extends Item {
    public ItemWindsweptUpgradeTemplate(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.competitivenetherite.windsweptupgradetemplate_0").withStyle(ChatFormatting.GRAY));
        ...
        pTooltipComponents.add(Component.translatable("tooltip.competitivenetherite.windsweptupgradetemplate_1").withStyle(ChatFormatting.WHITE));
    }
}
